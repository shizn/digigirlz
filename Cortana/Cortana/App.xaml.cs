...
namespace Cortana
{
    ...
    {
        static string iotHubUri = "xshiIoTHubTest.azure-devices.net";
        static string deviceId = "xshiDevice0";
        static string deviceKey = "pfw/Le4W8C4JZ1gCzOB8M5PZjLeO3Ykg2PLv0YbXXOw=";
        static string connectionString = "HostName=xshiIoTHubTest.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=A9O5MY5wbZli9OiBDZf4dD0B9XqC5p1hUNMRErIUIL0=";
            ...
            if (args.Kind == ActivationKind.VoiceCommand)
            {
                ...
                switch (voiceCommandName)
                {
                    case "switch":
                        ...
                        if (status.Equals("打开"))
                            messageString = "[{\"port\": 5, \"status\": 0}]";
                        else if (status.Equals("关闭"))
                            messageString = "[{\"port\": 5, \"status\": 1}]";
